...
| ---------- | ------ | -------- | ------------------------------------------------------------ |
| `access`   | object | body     | [Access options](https://inveniordm.docs.cern.ch/reference/metadata/#access) for the record. |
| `files`    | object | body     | Files options (see below) for the record. |
| `metadata` | object | body     | [Metadata](https://inveniordm.docs.cern.ch/reference/metadata/#metadata) of the record. |
...
| `id`       | string | path     | Identifier of the record, e.g.  `4d0ns-ntd89`                |
| `access`   | object | body     | [Access options](https://inveniordm.docs.cern.ch/reference/metadata/#access) for the record. |
| `files`    | object | body     | [Files options](https://inveniordm.docs.cern.ch/reference/metadata/#files) for the record. |
| `metadata` | object | body     | [Metadata](https://inveniordm.docs.cern.ch/reference/metadata) of the record. |
  ...
  "entries": [
    {
      ...
      "status": "pending",
      "links": {
        "content": "/api/packages/{id}/draft/files/figure.png/content",
        "self": "/api/packages/{id}/draft/files/figure.png",
        "commit": "/api/packages/{id}/draft/files/figure.png/commit"
      },
    },
        {
      "key": "article.pdf",
      ...
      "status": "pending",
      "links": {
        "content": "/api/packages/{id}/draft/files/article.pdf/content",
        "self": "/api/packages/{id}/draft/files/article.pdf",
        "commit": "/api/packages/{id}/draft/files/article.pdf/commit"
      },
    },
    {
      "key": "data.zip",
...

{
  ...
  "metadata": null,
	"status": "pending",
	"links": {
    "content": "/api/packages/{id}/draft/files/{filename}/content",
    "self": "/api/packages/{id}/draft/files/{filename}",
    "commit": "/api/packages/{id}/draft/files/{filename}/commit"
  },
}
```
...
curl \
  ...
  https://127.0.0.1:5000/api/packages/{id}/draft/files/{filename}/content \
